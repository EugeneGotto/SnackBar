...
namespace SnackBar.Areas.Admin.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(IServiceFactory factory) : base(factory)
        {
        }

        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, IServiceFactory factory) : base(factory)
        {
